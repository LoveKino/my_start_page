...
const TextField = require('kabanery-glare/src/base/TextField');
const Text = require('kabanery-glare/src/base/Text');
const {
  mount
} = require('kabanery');
...
const Page = glareView(({
  ...
  return n('div', {
    ...
    // active frame
    props.activeFrame ? bn(Frame, {
      propsPath: 'activeFrame'
    }) : null
  ]);
}, {
  defaultProps: {}
